...
*/
Vue.component("simple_footer_component_1721707911", {
    template: `
            ...
            <div id="footer-container" class="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
                ...
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-sm text-center text-gray-500 dark:text-gray-400">
                        Stay ahead of the curve with Discover Fresh. We scour the market to bring you the latest and most innovative products across categories. Sign up for our newsletter to never miss a new launch!
                    </div>
                </div>
            </div>
        </footer> 
